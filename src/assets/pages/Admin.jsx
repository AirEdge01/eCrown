...
const AdminPage = () => {
    ...
    const fetchAdminData = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:2000/api/admin/orders', {
    ...
    const handleCreateProduct = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:2000/api/admin/products', productPayload, {
                headers: {
                    ...getAdminAuthHeaders(),
    ...
    const handleRemoveProduct = async (productId) => {
        ...
        const deletionEndpoints = [
            `http://localhost:2000/api/admin/products/${productId}`,
    ...
    const handleApproveOrder = async (orderId) => {
        try {
            const response = await axios.put(`http://localhost:2000/api/admin/orders/${orderId}`, {
                status: 'Processing'
            });
