  ...
  return (
    <>
      ...
      <div className="about-wrapper">
        ...
        {/* --- SECTION 3: OFFICIAL CORE INSTALLATION ROSTER --- */}
        ...
        {/* --- SECTION 4: SAFETY, PROTOCOL & COMPLIANCE --- */}
        ...
        <Footer />
        <style>{`
          .about-wrapper { color: #0A1622; overflow-x: hidden; }
          .about-hero { background-image: url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2070'); background-size: cover; background-position: center; background-attachment: fixed; padding: 120px 0; }
          .hero-overlay { position: absolute; inset: 0; background: linear-gradient(135deg, rgba(6, 19, 33, 0.96) 0%, rgba(10, 22, 34, 0.85) 100%); z-index: 1; }
          .badge-premium { background: rgba(13, 110, 253, 0.12); border: 1px solid #0D6EFD; color: #00d4ff; padding: 6px 18px; border-radius: 50px; font-weight: 700; font-size: 11px; letter-spacing: 1.5px; display: inline-block; }
          .brand-pillars-ticker { font-size: clamp(11px, 3vw, 14px); color: #00d4ff; }
          ...
          .bg-light-surface { background-color: #fdfdfe; border-color: rgba(10, 22, 34, 0.06) !important; }
          .premium-quote-box { background: rgba(13, 110, 253, 0.03); border-color: #0D6EFD !important; }
          ...
          .bg-light-blueprint { background-color: #f4f7fa; background-image: radial-gradient(rgba(13, 110, 253, 0.03) 1px, transparent 0); background-size: 24px 24px; }
          .roster-card-premium { transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1); border-radius: 12px !important; }
          .roster-card-premium:hover { transform: translateY(-8px); box-shadow: 0 2rem 4rem rgba(6, 19, 33, 0.16) !important; border-color: rgba(13, 110, 253, 0.4) !important; }
          .roster-img-layer-premium { transition: transform 0.6s cubic-bezier(0.16, 1, 0.3, 1); filter: brightness(0.9) contrast(1.15); }
          .roster-card-premium:hover .roster-img-layer-premium { transform: scale(1.08); filter: brightness(1) contrast(1.2); }
          .bold-image-overlay { position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(10,22,34,0.1), rgba(10,22,34,0.4)); z-index: 2; pointer-events: none; }
          .roster-icon-premium-badge { position: absolute; bottom: -24px; left: 50%; transform: translateX(-50%); width: 52px; height: 52px; z-index: 4; border: 3px solid #ffffff; background-color: #ffffff !important; }
          .fw-black { font-weight: 800 !important; }
          .roster-title-heavy { font-size: 20px; letter-spacing: -0.3px; color: #061321; }
          .tracking-tight { letter-spacing: -0.5px; }
          .values-section { background: radial-gradient(circle at center, #0a2440 0%, #050d14 100%); }
          .value-card { background: rgba(255, 255, 255, 0.02); border-color: rgba(255, 255, 255, 0.08) !important; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); }
          .value-card:hover { transform: translateY(-4px); background: rgba(255, 255, 255, 0.04); border-color: rgba(0, 212, 255, 0.2) !important; }
          .text-info-light, .text-info-cyan { color: #00d4ff !important; }
          .visual-curve-container { background: #061321; }
          .flyer-abstract-curve { position: absolute; inset: 0; background: radial-gradient(circle at bottom right, #0D6EFD 0%, transparent 65%); z-index: 2; pointer-events: none; opacity: 0.65; }
          .minimal-image { filter: grayscale(0.12); transition: all 0.4s ease; }
          .minimal-image:hover { filter: grayscale(0); transform: scale(1.01); }
          .cta-banner { background-color: #061321 !important; }
          .flyer-bottom-sweep-overlay { position: absolute; top: 0; right: -10%; bottom: 0; width: 55%; background: linear-gradient(120deg, transparent 20%, #0D6EFD 100%); opacity: 0.45; transform: skewX(-20deg); z-index: 1; }
          .btn-light-shimmer { background: #ffffff; color: #0A1622; border: none; transition: all 0.25s ease; }
          .btn-light-shimmer:hover { background: #0D6EFD; color: #ffffff; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(13, 110, 253, 0.35) !important; }
          .z-3 { z-index: 3; }
          .z-1 { z-index: 1; }
        `}
        </style>
